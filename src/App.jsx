...
const Progetti = React.lazy(() => import("./pages/protected/Progetti.jsx"));

import ScrollToTop from "./components/ScrollToTop.jsx";

import PostRegistration from "./utility/PostRegistration";
import LMFront from "./pages/protected/LMFront.jsx";
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoutes />}>
            <Route path="/LMFront" element={<LMFront />} />
            <Route path="/print/:token/:idTemplate" element={<Progetti />} />
          </Route>
        </Routes>
      </Router>
    </Suspense>
